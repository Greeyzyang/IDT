...
public class WyzeJsonDevicesActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wyzeactivity_json);
    ...
    private void unbindDevice() {
        DeviceManager.getInstance().unbind(new AsyncBleCallback<Void, BleError>() {
            ...
            public void onSuccess(Void result) {
                ...
                startActivity(new Intent(WyzeJsonDevicesActivity.this, ScanActivity.class));
            }
