...
public class MainActivity extends AppCompatActivity {
    ...
    private void syncDeviceData(View view) {
        view.setBackgroundColor(getResources().getColor(R.color.colorNormal));
        DeviceManager.getInstance().getDevice().syncDeviceData(new DataUploadAsyncCallback<List<DeviceDataSet>, BleError>() {
            @Override
            ...
            @Override
            public void onSuccess(List<DeviceDataSet> result) {
