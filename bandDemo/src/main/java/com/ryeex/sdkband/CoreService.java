...
public class CoreService extends Service {
    ...
    public void onCreate() {
        ...
        DeviceManager.getInstance().setOnVoiceListener(onVoiceListener);
        connect();
    }
    ...
    private DeviceConnectListener deviceConnectListener = new DeviceConnectListener() {
        ...
        public void onLoginSuccess() {
            ...
            DeviceManager.getInstance().getDevice().sendVoiceStatus(0, null);
        }
    ...
    private OnVoiceListener onVoiceListener = new OnVoiceListener() {
        ...
        public void onReceiveBytes(byte[] bytes) {
            ...
            //如果云端有截断，则可通过
            //DeviceManager.getInstance().getDevice().sendVoiceStop(voidSessionId, null);
        ...
        public void onReceiveBytesFinish(int sessionId) {
            ...
            BleHandler.getWorkerHandler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    DeviceManager.getInstance().getDevice().sendVoiceCaption("voice test", false, voidSessionId, null);
                }
            }, 1000);
        }
            ...
            public void onCallStateChanged(int state, String incomingNumber) {
                switch (state) {
                    ...
                    case TelephonyManager.CALL_STATE_IDLE:
                        ...
                        isIncomeCall = false;
                        String contactIdle = ContactUtil.getContactByNumber(CoreService.this, incomingNumber);
                    ...
                    case TelephonyManager.CALL_STATE_RINGING:
                        ...
                        isIncomeCall = true;
                        String contactRinging = ContactUtil.getContactByNumber(CoreService.this, incomingNumber);
                    ...
                    case TelephonyManager.CALL_STATE_OFFHOOK:
                        ...
                        isIncomeCall = false;
                        String contactOff = ContactUtil.getContactByNumber(CoreService.this, incomingNumber);
